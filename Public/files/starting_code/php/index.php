		...
		<div id="jp_widget">
	        ...
	        <table align="center" class="upgotd-table" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	                <td>Status:</td>
	                <td>
	                	<a href="https://joshuaproject.net/definitions.php?term=25" class="upgotd-link pg-scale-text"></a> (<a href="https://joshuaproject.net/global-progress-scale.php" class="upgotd-link pg-scale"></a>&nbsp;<a href="https://joshuaproject.net/global-progress-scale.php" class="upgotd-link" id="progress-scale-image"></a>)
	                </td>
	            </tr>
	        </tbody></table>

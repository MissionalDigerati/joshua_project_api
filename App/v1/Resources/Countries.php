...
/**
  ...
  *              @SWG\Parameter(
  *                  name="id",
  *                  description="The 2 letter ISO Country Code for the Country you want to view. [<a href='http://goo.gl/31Gf' target='_blank'>View all Country Codes</a>]",
  *                  paramType="path",
  *                  required="true",
  *                  allowMultiple="false",
  *                  dataType="string"
 ...
 *              @SWG\Parameter(
 *                  name="ids",
 *                  description="A bar separated list of one or more ISO 2 Letter Country Codes to filter by. See <a href='http://goo.gl/31Gf' target='_blank'>http://goo.gl/31Gf</a>.",
 *                  paramType="query",
 *                  required="false",
 *                  allowMultiple="false",
 *                  dataType="string"

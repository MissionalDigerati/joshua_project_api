...
class PeopleGroup extends QueryGenerator
{
    ...
    protected $fieldsToSelectArray = array(
        ...
        'PrimaryLanguageDialect', 'NumberLanguagesSpoken', 'OfficialLang',
        ...
        'LRTop100', 'PhotoAddress', 'PhotoCredits', 'PhotoCreditURL',
        'PhotoCreativeCommons', 'PhotoCopyright', 'PhotoPermission', 'ProfileTextExists', 'CountOfCountries',
        'CountOfProvinces', 'Longitude', 'Latitude', 'Ctry', 'IndigenousCode', 'ROL3',

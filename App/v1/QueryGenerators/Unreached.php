...
class Unreached extends PeopleGroup
{
    ...
    protected $fieldsToSelectArray = array(
        ...
        'jpupgotd.Ctry', 'jpupgotd.ROL3', 'jpupgotd.PercentAdherents', 'jpupgotd.PercentEvangelical',
        'jpupgotd.RegionCode', 'jppeoples.ROP3', 'jppeoples.ISO3', 'jppeoples.LocationInCountry',
        'jppeoples.ROP1', 'jppeoples.ROP2', 'jppeoples.Category',
        'jppeoples.PrimaryLanguageDialect', 'jppeoples.NumberLanguagesSpoken',
        ...
        'jppeoples.SecurityLevel', 'jppeoples.LRTop100', 'jppeoples.ProfileTextExists', 'jppeoples.CountOfProvinces',
        'jppeoples.IndigenousCode', 'jppeoples.PercentChristianPC',
        'jppeoples.PercentChristianPGAC', 'jppeoples.PercentEvangelicalPC', 'jppeoples.PercentEvangelicalPGAC',
        'jppeoples.PCBuddhism', 'jppeoples.PCEthnicReligions', 'jppeoples.PCHinduism',

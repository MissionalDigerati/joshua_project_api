...
class Unreached extends PeopleGroup
{
    ...
    protected $fieldsToSelectArray = array(
        ...
        'jppeoples.ROP1', 'jppeoples.ROP2', 'jppeoples.PopulationPercentUN', 'jppeoples.Category', 'jppeoples.ROL4',
        ...
        'jppeoples.PCNonReligious', 'jppeoples.PCUnknown',
        'jppeoples.PCOrthodox', 'jppeoples.PCOtherChristian', 'jppeoples.SecurityLevel',

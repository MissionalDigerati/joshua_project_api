...
?>
                        ...
                        <div class="terms-of-use checkbox<?php echo ((!empty($errors)) && (in_array('terms_of_use', $errors))) ? ' has-error' : ''; ?>">
                            <label>
                                ...
                                I agree to the <a href="/terms_of_use" target="_blank">Terms of Use</a><span class="required-field">*</span>&nbsp;&nbsp;(<a href="\files\pdfs\joshua-project-API-terms-of-use.pdf">PDF</a> <a href="\files\pdfs\joshua-project-API-terms-of-use.pdf"><span aria-hidden='true' class='glyphicon glyphicon-download-alt'></span></a>)
                            </label>

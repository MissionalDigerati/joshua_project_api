...
?>
    <div class="container">
        ...
        <p>You may not use the data in a public manner that replicates the services or presentation offered by Joshua Project. Heavily replicating the core functionalities or providing a highly overlapping service using Joshua Project content is prohibited. API users creating public presentations should provide some kind of value-added rather than a re-packaging of Joshua Project content. If you have any questions, please contact us at <a href="mailto:info@joshuaproject.net">info@joshuaproject.net</a>.</p>

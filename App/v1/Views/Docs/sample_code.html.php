...
?>
  <div class="container">
    ...
    <p>Here you will find some examples in multiple programming languages of how to implement the Joshua Project API.  
      If you would like to download these examples,  please 
      <a href="https://github.com/MissionalDigerati/joshua_project_api_sample_code/archive/master.zip">click here</a>.  
      You will need to get an API key to use these examples.  You can also view the code on 
      <a href="https://github.com/MissionalDigerati/joshua_project_api_sample_code" target="_blank">Github</a>.</p>
    <div id="repo"></div>
  </div>
<?php
